...
class LoadModuleFromModuleNameTest(unittest.TestCase, utils.TestDataMixin):
  ...
  def test_broken_module(self):
    modulename = self.test_package_name + '.brokenmodule_test'
    result_errors = []
  ...
  def test_valid_module(self):
    modulename = self.test_package_name + '.goodmodule_test'
    result_errors = []
    result_module = logic.load_module_from_module_name(modulename,
                                                   result_errors)
    self.assertNotEqual(None, result_module)
...
class GetRequestedObjectTest(unittest.TestCase, utils.TestDataMixin):
  ...
  def test_module(self):
    fullname = self.test_package_name + '.goodmodule_test'
  ...
  def test_class(self):
    fullname = self.test_package_name + '.goodmodule_test.Foo'
    result = logic.get_requested_object(fullname)
    self.assertNotEqual(None, result)
  ...
  def test_method(self):
    fullname = self.test_package_name + '.goodmodule_test.Foo.bar'
    result = logic.get_requested_object(fullname)
    self.assertNotEqual(None, result)
...
class LoadAndRunTestsTest(unittest.TestCase, utils.TestDataMixin):
  ...
  def setUp(self):
    self.setup_test_data()
    self.module_name = self.test_package_name + '.one_testcase_test'
